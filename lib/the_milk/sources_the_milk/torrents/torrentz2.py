    ...
    def sources(self, data, host_dict):
        ...
        for row in rows:
            try:
                ...
                append({'provider': 'torrentz2', 'source': 'torrent', 'seeders': seeders, 'hash': hash, 'name': name,
                        'name_info': name_info,
    ...
    def get_sources_packs(self, link):
        ...
        for row in rows:
            try:
                ...
                item = {'provider': 'torrentz2', 'source': 'torrent', 'seeders': seeders, 'hash': hash, 'name': name,
