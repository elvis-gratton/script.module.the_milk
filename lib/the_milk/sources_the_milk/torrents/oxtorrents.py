...
class source:
    ...
    def __init__(self):
        self.language = ['fr']
        self.base_link = "https://www.oxtorrents.co"
        self.search_films_link = '/recherche/films'
        self.search_series_link = '/recherche/series'
        self.min_seeders = 0
    ...
    def sources(self, data, host_dict):
        ...
        try:
            ...
            url = quote_plus(tmp)
            link = '%s%s/%s' % (self.base_link, tmp_url, url)
    ...
    def get_sources(self, link):
        ...
        for row in rows:
            ...
            if not result_html or '<div class="btn-magnet">' not in result_html:
                continue
            ...
            self.sources_append(
                {'provider': 'oxtorrents', 'source': 'torrent', 'seeders': seeders, 'hash': hash40, 'name': name,
                 'name_info': name_info,
    ...
    def sources_packs(self, data, host_dict, search_series=False, total_seasons=None, bypass_filter=False):
        ...
        try:
            ...
            log_utils.error('sources_packs %s' % str(e))
            return self.sources
    ...
    def get_sources_packs(self, season_url):
        ...
        for row in rows:
            ...
            episode_start, episode_end, valid, package = 0, 0, False, None
            ...
            item = {'provider': 'oxtorrents', 'source': 'torrent', 'seeders': seeders, 'hash': hash40, 'name': name,
