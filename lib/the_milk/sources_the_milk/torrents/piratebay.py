...
from the_milk.modules import client, source_utils
    ...
    def sources(self, data, host_dict):
        ...
        for file in files:
            try:
                ...
                sources_append(
                    {'provider': 'piratebay', 'source': 'torrent', 'seeders': seeders, 'hash': hash, 'name': name,
                     'name_info': name_info,
    ...
    def get_sources_packs(self, link):
        ...
        for file in files:
            try:
                ...
                item = {'provider': 'piratebay', 'source': 'torrent', 'seeders': seeders, 'hash': hash, 'name': name,
