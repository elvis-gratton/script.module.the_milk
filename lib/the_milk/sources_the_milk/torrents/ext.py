    ...
    def sources(self, data, host_dict):
        ...
        for row in rows:
            try:
                ...
                link = \
                client.parseDOM(columns[0], 'a', attrs={'class': 'dwn-btn torrent-dwn'}, ret='href')[0].split('&amp')[0]
                ...
                append({'provider': 'ext', 'source': 'torrent', 'seeders': seeders, 'hash': hash, 'name': name,
                        'name_info': name_info,
    ...
    def get_sources_packs(self, link):
        ...
        for row in rows:
            try:
                ...
                item = {'provider': 'ext', 'source': 'torrent', 'seeders': seeders, 'hash': hash, 'name': name,
